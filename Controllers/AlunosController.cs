...
namespace ProjetoLogin.Controllers
{
    public class AlunosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AlunoId,Nome,Email,Celular,CPF,DataNasc,RM,DataCadastro,CadastroAtivo,Enedreco,Bairro,Cidade,UF,CEP,Numero,UrlFoto")] Aluno aluno)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("AlunoId,Nome,Email,Celular,CPF,DataNasc,RM,DataCadastro,CadastroAtivo,Enedreco,Bairro,Cidade,UF,CEP,Numero,UrlFoto")] Aluno aluno)
        {
            if (id != aluno.AlunoId)
            {
                return NotFound();
